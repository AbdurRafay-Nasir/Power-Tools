...
- [Group](#group-attributes) Works on multiple fields.
- [Scene](#scene-attributes) Works on individual fields. Has effects in SceneView. No custom inspector is made 
- [Property](#property-attributes) Only works on individual fields (Button is exception as it works on Methods).  
